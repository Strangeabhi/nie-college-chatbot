"""
NIE Advanced Chatbot - Deployment Ready Version
Optimized for hosting with minimal memory usage
"""
...
Note: These are last year's figures and may change for current admissions.""", 0.8
    ...
    def get_response(self, user_query: str, user_id: str = "default") -> Tuple[str, float]:
        ...
        try:
            ...
            if any(greeting in cleaned_query for greeting in ['hi', 'hello', 'hey', 'good morning', 'good afternoon', 'good evening']):
                return "Hello! I'm here to help you with information about NIE Mysuru. What would you like to know about admissions, placements, hostels, courses, or anything else?", 0.9
            
            if any(phrase in cleaned_query for phrase in ['how are you', 'how do you do', 'what\'s up', 'whats up']):
                return "I'm doing great, thanks for asking! I'm here to help you with all your NIE-related questions. What can I assist you with today?", 0.9
            
            if any(phrase in cleaned_query for phrase in ['thank you', 'thanks', 'bye', 'goodbye', 'see you']):
                return "You're welcome! Feel free to ask if you have any more questions about NIE. Have a great day!", 0.9
            ...
            # Special handling for generic cutoff queries
            if any(word in cleaned_query for word in ['cutoff', 'cut off', 'ranks', 'rank']) and \
...
if __name__ == '__main__':
    ...
    print("🚀 Starting NIE Advanced Chatbot (Deployment Ready)...")
    print("💬 Dynamic responses and external fallback")
    print("⚡ Optimized for hosting")
